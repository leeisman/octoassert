...
func NewRegistry() *runner.Registry {
	...
	registry.Register(websocket.New("websocket_connect"))
	registry.Register(websocket.New("websocket_send"))
	registry.Register(websocket.New("websocket_await"))
	registry.Register(websocket.New("websocket_close"))
